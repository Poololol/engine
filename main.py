...
rend.getScene('Sphere').addObjectFromObj(r"C:\Users\braed\OneDrive\Documents\sphere-5.obj", 'sphere')
rend.getScene('Sphere').getObject('sphere').translate(Vec3(0, 0, 3))
rend.getScene('Sphere').addObjectFromObj(r"C:\Users\braed\OneDrive\Documents\sphere.obj", 'sphere2')
...
if __name__ == '__main__':
    ...
    while run:
        ...
        #rend.getScene('Sphere').getObject('sphere').rotate((pi/10 * dt, 0.0, 0.0))
        ...
        '''if frame >= 0:
            for i in range(len(rend.getCurrentScene().objects[1].faces)):
                face = rend.getCurrentScene().objects[1].faces[i]
                o = (GameObject([Face([Vec3(0, 0, 0), face.normal/10, face.normal/10 + Vec3(1,1/2,1)/100], (255, 0, 255))], f'Normal-{i}', Vec3(0,0,0), dt/1.5))
